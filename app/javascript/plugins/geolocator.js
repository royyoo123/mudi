	...
	function success(pos) {
	  ...
	  if(a){
	  	...
	  	a.addEventListener('click',(event) => {
			window.location.href=`https://mudi.live/events?latitude=${crd.latitude}&longitude=${crd.longitude}`;
			})
		} else if (b) {
			b.addEventListener('click',(event) => {
			window.location.href=`https://mudi.live/events/map?latitude=${crd.latitude}&longitude=${crd.longitude}`;
			})
		} else if (c) {
